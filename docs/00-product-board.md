...
|---|---|---|---|---|
| B-005 | Page Absences : signaler ce qui est **nouveau** (souhaits, echanges, depannages non traites) sur le tableau/accueil. Decrit dans LOT 2 du plan du 22/08, jamais lance — detecte par OTTO le 24/08 comme chantier oublie. | Anne-Sophie / plan 22/08 | 2026-08-22 | MiKL |
